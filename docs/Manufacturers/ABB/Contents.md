...
You'll find a number of different ABB controllers in our catalogs but between the multiple _OmniCore_ and _IRC5_ versions the only major difference is the geometry. The [Controller](../../Overview/Glossary.md#controller) type (_OmniCore_ or _IRC5_) will also define which software versions are available and therefore which [Subsystems](../../Overview/Glossary.md#subsystems) can be chosen.

| Subsystem Name | Description | Capabilities | Configuration |
| -------------- | ----------- | ------------ | ------------- |
| ABB RAPID X.X   | Translates [Procedures](../../Overview/Glossary.md#procedure) to ABB's RAPID programming language. | [Language](../../Overview/Glossary.md#capabilities) | > Enabled - Whether to export the procedure.<br>> Library Mode - Whether to export code that will run directly or that can be called from another function.<br>> Max Actions - Maximum number of actions to have in a single _.mod_ file. Any more and the [Procedure](../../Overview/Glossary.md#procedure) will be created in multiple files. The maximum allowed by ABB is around 35,000 lines.<br>> Task Alias - Name of the _Task_ into which the [Procedure](../../Overview/Glossary.md#procedure) should be [uploaded](../../Overview/Glossary.md#upload). |
| PCSDK | Remote [Controller](../../Overview/Glossary.md#controller) interaction library (available in RobotWares before 7.x) which requires the installation of he SDK with either RobotStudio or with the HAL.ABB extension. | [Upload](../../Overview/Glossary.md#capabilities)<br>[Execution](../../Overview/Glossary.md#capabilities)<br>[Monitor](../../Overview/Glossary.md#capabilities)<br>[File Manager](../../Overview/Glossary.md#capabilities)<br>[Read Signals](../../Overview/Glossary.md#capabilities)<br>[Write Signals](../../Overview/Glossary.md#capabilities)<br>[Logger](../../Overview/Glossary.md#capabilities)<br>[Backup](../../Overview/Glossary.md#capabilities) | > IP - IP address of your remote robot or simulator.<br>> Credentials - Credentials needed to log in to the robot (or [simulator](#3-simulation)) remotely. Defaults will work unless they have been changed in your robot's settings. <br>> Detected Controllers - Selectable controllers which the PCSDK has discovered on your network. |
| Robot Web Services (RWS) | Successor to the PCSDK which allows HTTP-based communication with the [controller](../../Overview/Glossary.md#controller) (available in RobotWares 6.x or later). | [Upload](../../Overview/Glossary.md#capabilities)<br>[Execution](../../Overview/Glossary.md#capabilities)<br>[Monitor](../../Overview/Glossary.md#capabilities)<br>[File Manager](../../Overview/Glossary.md#capabilities)<br>[Read Signals](../../Overview/Glossary.md#capabilities)<br>[Write Signals](../../Overview/Glossary.md#capabilities)<br>[Logger](../../Overview/Glossary.md#capabilities)<br>[Execution Monitoring](../../Overview/Glossary.md#capabilities) | > IP - IP address of your remote robot or simulator.<br>> Credentials - Credentials needed to log in to the robot (or [simulator](#3-simulation)) remotely. Defaults will work unless they have been changed in your robot's settings. |
| Externally Guided Motion (EGM) | Enables low-latency state streaming to/from the [controller](../../Overview/Glossary.md#controller) via ABB's Externally Guided Motion (EGM) protocol. This requires a software option from ABB and configuration on the [controller](../../Overview/Glossary.md#controller). | [Monitor](../../Overview/Glossary.md#capabilities)<br>[Stream](../../Overview/Glossary.md#capabilities)<br>[Receive State](../../Overview/Glossary.md#capabilities) | > IP - IP address of your remote robot or simulator.<br>> Port - Port configured on the [controller](../../Overview/Glossary.md#controller) to receive EGM commands. |
